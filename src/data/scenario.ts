...
⚠️ 评分核心原则：本游戏评估的是学员把 AI 变成决策外援的能力，而不是经营知识考试，也不是数据复述能力。评分必须严格区分"业务理解 + AI 协作"与"照搬资料"。
...
1. 目标定义：是否把本关真正要解决的问题、优先目标说清楚？
2. 业务理解：是否主动补充或引用了业务事实、客户、成本、合同、库存、竞争等上下文，而不是只问泛泛建议？
3. 约束表达：是否明确预算、人手、时间、风险底线、不可做事项等限制？
4. 追问迭代：是否会让 AI 反问、补充缺口、比较方案、预演风险、修正判断？
5. 落地验证：最终方案是否能变成具体动作，并有验证指标或复盘方式？
...
请严格输出JSON格式，不要包含任何额外说明：
{
  ...
  "total": 总分,
  "comment": "必须用中文，按“优秀：...”和“待改进：...”两段书写。聚焦学员如何和 AI 协作做决策；如发现照搬数据，必须指出。"
}`,
  },
